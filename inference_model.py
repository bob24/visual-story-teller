...
dataset_type = "train"
model_name = "2020-01-23_11-13-50-2020-01-25_23-35-38"
...
inference = Inference('./stories_to_' + dataset_type +'_index_myCNN.hdf5',
...
inference.predict_all(batch_size=50, references_file_name='',
                      hypotheses_file_name="./results1/" + model_name + "/hypotheses_alex_" + dataset_type + ".txt",
